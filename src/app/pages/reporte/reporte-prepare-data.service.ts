...
import {ReporteConsumoModel} from '../../models/consumo_previo.model';

@Injectable()
export class ReportePrepareDataService {

  prepareDataConsumo(form: FormGroup): ReporteConsumoModel {
